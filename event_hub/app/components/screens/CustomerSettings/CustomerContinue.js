...
class ContinueBooking extends Component {
  constructor(props) {
    super(props);
    this.state = {
      typeOfBooking: "ContinueCustomer",
      data: []
    };
  }
  ContinueBookingForHall() {
    var url;
    if (global.typeOfCompany === "Hall") {
      url =
        "https://eventhub-api.conveyor.cloud/api/User/CustomerApprovedRequestsHall?id=" +
        global.id;
    } else if (global.typeOfCompany === "Media") {
      url =
        "https://eventhub-api.conveyor.cloud/api/Media/CustomerApprovedRequestsMedia?id=" +
        global.id;
    } else if (global.typeOfCompany === "Caterer") {
      url =
        "https://eventhub-api.conveyor.cloud/api/Caterer/CustomerApprovedRequestsMedia?id=" +
        global.id;
    }
